...
router.include_router(seller_reports.user_router)
router.include_router(listing_reports.user_router)
router.include_router(looking_for_reports.user_router)
...
router.include_router(listing_reports.admin_router, dependencies=[Depends(require_dashboard_api_session)])
router.include_router(looking_for_reports.admin_router, dependencies=[Depends(require_dashboard_api_session)])
router.include_router(conversation_reports.router, dependencies=[Depends(require_dashboard_api_session)])
router.include_router(seller_reports.admin_router, dependencies=[Depends(require_dashboard_api_session)])
